...
describe PeopleController do
  ...
  let(:valid_attributes) { { "fname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved person as @person" do
        ...
        post :create, {:person => { "fname" => "invalid value" }}, valid_session
        assigns(:person).should be_a_new(Person)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested person" do
        ...
        Person.any_instance.should_receive(:update).with({ "fname" => "MyString" })
        put :update, {:id => person.to_param, :person => { "fname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the person as @person" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Person.any_instance.stub(:save).and_return(false)
        put :update, {:id => person.to_param, :person => { "fname" => "invalid value" }}, valid_session
        assigns(:person).should eq(person)
      end
